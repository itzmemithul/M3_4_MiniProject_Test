...
WalmartSales_pipe = Pipeline([
    ...
    ######### Scaling ###########
    ('column_scaler_temp', ColumnScaler(variable = config.model_config.temperature_var)), 
    ('column_scaler_fuelprice', ColumnScaler(variable = config.model_config.fuel_price_var)),
    ('column_scaler_cpi', ColumnScaler(variable = config.model_config.cpi_var))
    ('column_scaler_unemployment', ColumnScaler(variable = config.model_config.unemployment_var))
